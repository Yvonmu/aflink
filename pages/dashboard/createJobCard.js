          ...
          <div>
            <div className="flex md:w-full mb-4 sm:flex-wrap w-1/2 md:space-x-8 sm:space-y-4 font-serif">
              ...
              <div className="w-full flex">
                <div className="md:w-1/4 sm:w-1/2 capitalize">date</div>
                <div className="md:w-3/4 sm:w-1/2">
                  <input
                    className="border border-red-300 rounded"
                    type={"date"}
            ...
            <div className="flex md:w-full mb-4 sm:flex-wrap w-1/2 md:space-x-8 sm:space-y-4 font-serif">
              <div className="w-full flex space-x-4">
                <div className="md:w-1/4 sm:w-1/2 capitalize">Customer</div>
                <div className="md:w-3/4 sm:w-1/2">
                  <input
                    className="border border-red-300 rounded"
                    type={"text"}
            ...
            <div className="flex md:w-full mb-4 sm:flex-wrap w-1/2 md:space-x-8 sm:space-y-4 font-serif">
              <div className="w-1/2 flex space-x-4">
                <div className="md:w-1/4 sm:w-1/2 capitalize text-sm">
                  Payment method
                </div>
                <div className="md:w-3/4 sm:w-1/2">
                  <select className="border border-red-300 w-2/3 px-2 rounded">
