            ...
            <div className="py-4 px-8">
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className="appearance-none border rounded w-full py-2 px-3 bg-white"
                >
                  <option>sdf</option>
                  <option>sdf</option>
                  <option>sdf</option>
              ...
              <div className="flex items-center justify-center mt-8">
                {loading ? (
                  ...
                  <button
                    ...
                    className="bg-green-600 font-bold inline-flex justify-center py-2 px-4 border border-transparent shadow-sm rounded-md text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    Upload
                  </button>
                )}
